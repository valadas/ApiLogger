...
class Build : NukeBuild
{
    ...
    private string prodViewsPath = "/DesktopModules/ApiLogger/resources/scripts/era-apilogger/";
    ...
    Target DeployFrontEnd => _ => _
        ...
        .Executes(() =>
        {
            var scriptsDestination = RootDirectory / "resources" / "scripts" / "era-apilogger";
            EnsureCleanDirectory(scriptsDestination);
            CopyDirectoryRecursively(RootDirectory / "module.web" / "dist" / "era-apilogger", scriptsDestination, DirectoryExistsPolicy.Merge);
        });
    ...
    Target Swagger => _ => _
        ...
        .Executes(() =>
        {
            ...
            NSwagTasks.NSwagWebApiToOpenApi(c => c
                .AddAssembly(RootDirectory / "bin" / Configuration / "Eraware.Modules.ApiLogger.dll")
                .SetInfoTitle("Eraware API Logger")
