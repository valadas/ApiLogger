...
namespace Eraware.Modules.ApiLogger.Services
{
    ...
    using static Eraware.Modules.ApiLogger.ViewModels.LocalizationViewModel;
    ...
    public class LocalizationService : ILocalizationService
    {
            ...
            get
            {
                if (string.IsNullOrWhiteSpace(this.resourceFileRoot))
                {
                    this.resourceFileRoot = HostingEnvironment.MapPath(
                        "~/DesktopModules/ApiLogger/resources/App_LocalResources/");
                }
        ...
        public LocalizationService()
        {
            ...
            this.cacheKey = "Eraware.Modules.ApiLogger" + "_Localization_" + Thread.CurrentThread.CurrentCulture;
